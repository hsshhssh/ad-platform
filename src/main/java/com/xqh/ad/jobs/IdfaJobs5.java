...
import com.xqh.ad.utils.condition.IdfaReportJobsCondition5;
...
@Slf4j
@Component
@Conditional(IdfaReportJobsCondition5.class)
public class IdfaJobs5
{
    @Autowired
    ...
    public void getAndSendIdfa() {
        idfaJobsService.getAndSendIdfa("5");
    }
