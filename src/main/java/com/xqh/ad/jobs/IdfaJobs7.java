...
import com.xqh.ad.utils.condition.IdfaReportJobsCondition7;
...
@Slf4j
@Component
@Conditional(IdfaReportJobsCondition7.class)
public class IdfaJobs7
{
    @Autowired
    ...
    public void getAndSendIdfa() {
        idfaJobsService.getAndSendIdfa("7");
    }
