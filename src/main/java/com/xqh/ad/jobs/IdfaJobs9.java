...
import com.xqh.ad.utils.condition.IdfaReportJobsCondition9;
...
@Slf4j
@Component
@Conditional(IdfaReportJobsCondition9.class)
public class IdfaJobs9
{
    @Autowired
    ...
    public void getAndSendIdfa() {
        idfaJobsService.getAndSendIdfa("9");
    }
